...
It also demonstrates using `event.dataTransfer` to move data between Ember components on drag actions.
...
* `git clone https://github.com/JeffreyRuder/Portfolio.git`
